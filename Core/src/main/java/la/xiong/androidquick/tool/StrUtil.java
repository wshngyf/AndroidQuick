...
public class StrUtil {
     ...
     *
     * @param str 需要判断的字符串
     * @return 返回的结果 true表明有特殊字符，false 没有
     */
    ...
    public static boolean userNameFilter(String str) {
        ...
        try {
            // 只允许字母、数字和下划线、中线
            Pattern p = Pattern.compile("^([a-z_A-Z-0-9]+)$");
            Matcher m = p.matcher(str);
    ...
    public static boolean checkMobileNO(String mobiles) {
        String str = "^13[0-9]{1}[0-9]{8}$|15[0-9]{1}[0-9]{8}$|18[0-9]{1}[0-9]{8}$";
        Pattern ps = Pattern.compile(str);
